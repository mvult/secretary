...
const file_secretary_v1_todos_proto_rawDesc = "" +
	...
	"\ahistory\x18\x01 \x03(\v2\x19.secretary.v1.TodoHistoryR\ahistory*\x9e\x01\n" +
	"\n" +
	"TodoStatus\x12\x1b\n" +
	"\x17TODO_STATUS_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10TODO_STATUS_TODO\x10\x01\x12\x15\n" +
	"\x11TODO_STATUS_DOING\x10\x02\x12\x14\n" +
